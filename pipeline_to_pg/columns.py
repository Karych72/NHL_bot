all_goals_potentional_change_columns = ['goal_player_id', 'total_goals', 'assist_player1_id', 'assist_total_1',                                            'assist_player2_id', 'assist_total_2', 'team_id']
all_goals_nan_values = [-9999, 0, -9999, 0, -9999, 0, -9999]
all_goalies_potentional_change_columns = ['savePercentage', 'powerPlaySavePercentage', 'shortHandedSavePercentage',
                                              'evenStrengthSavePercentage']
all_goalies_nan_values = [100, 100, 100, 100]
all_players_potentional_change_columns = ['faceOffPct']
all_players_nan_values = [0]
all_goals_columns = ['goal_player_id', 'total_goals', 'assist_player1_id', 'assist_total_1', 'assist_player2_id',
                         'assist_total_2', 'empty_net', 'winner_goal', 'is_ppg', 'is_shg', 'team_id', 'game_id']
game_team_stats_columns = ['goals', 'pim', 'shots', 'powerPlayPercentage', 'powerPlayGoals',
