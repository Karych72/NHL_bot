...
| [`classifier_modeling/`](classifier_modeling/) | Прематч-классификаторы NHL — этапы 1–13 [`nhl_classifier_modeling_plan_UPDATE.md`](../plan/classifier/nhl_classifier_modeling_plan_UPDATE.md); см. [`classifier_modeling/README.md`](classifier_modeling/README.md). |
