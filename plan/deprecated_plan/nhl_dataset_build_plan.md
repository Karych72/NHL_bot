...
**Статус:** выполнено (архив контрактного ТЗ). Реализация: `modeling/dataset_builder/`, `modeling/cli.py`, `tests/test_modeling_dataset_build.py`. Документ остаётся опорным описанием контракта.
